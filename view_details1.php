			...
			<div class="col-md-12">
				<div class="panel panel-default box-shadow">
					<?php 
						...
						//echo $row['user_id']."!=".$userid;
						/*if(($usertype != 'Admin' && $row['confidential'] == 'Yes') || ($row['user_id']!=$userid)){
					    	echo "<script>alert('You are not allowed to view this document.'); window.location='viewrecord.php';</script>";
					    }
*/				
					    if($row['confidential']=='Yes'){
					    	if(($usertype=='Staff') || ($usertype=='Manager' && $row['user_id']!=$userid)){
					    		echo "<script>alert('You are not allowed to view this document.'); window.location='viewrecord.php';</script>";
					    	} 
							...
							<div class="col-lg-6" style="border-right:1px solid #e5e7ec">
								<table width="100%">
									<tr>
										...
										<td class="tr-class" width="65%"><span><?php echo (!empty($row['logged_date']) ? date("F d, Y",strtotime($row['logged_date'])) : '');?></span></td>
									</tr>
									<tr>
	                                    ...
	                                    <div class="modal-dialog">
	                                        <div class="modal-content">
	                                            ...
	                                            <div class="modal-body">
	                                                <div class="zoomin">
	                                                	<center>
	                                                    <img id="image-gallery-image" class="img-responsive" src=""></center> 
	                                                </div>
	                                            </div>
